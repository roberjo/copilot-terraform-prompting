...
Use these minimal examples to learn one resource at a time. Each folder contains a README with simple steps.
...
- `examples/api-gateway-custom-domain/`: Custom domain + base path mapping + Route 53 alias
